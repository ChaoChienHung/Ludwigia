  ...
  let bundles = {
    common: {
      ...
      entries: [
        ...
        { selector: '[data-nav-credentials]', text: { en: 'Achievements', 'zh-Hant': '成就', 'zh-Hans': '成就' } },
        { selector: '[data-nav-timeline]', text: { en: 'Timeline', 'zh-Hant': '時間軸', 'zh-Hans': '时间轴' }, cipherText: { en: 'Chronology', 'zh-Hant': 'Chronology', 'zh-Hans': 'Chronology' } },
