    ...
    <div className="w-screen h-screen bg-black relative overflow-hidden font-mono select-none">
      ...
      {gameState === 'menu' && (
        <div className="absolute inset-0 bg-black/80 flex flex-col items-center justify-center z-10 pointer-events-auto">
          <div className="mb-5 flex flex-wrap items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] text-cyan-200/80">
          ...
          <p className="text-center text-sm text-cyan-100/70 max-w-xl mb-8 px-6 leading-relaxed">
            Current prototype focus: arena feel, HUD rhythm, and the basic multiplayer combat loop.
            Progression, onboarding, and site-level narrative framing are still being shaped.
          </p>
